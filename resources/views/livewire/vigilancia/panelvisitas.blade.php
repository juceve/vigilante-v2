<div>
    ...
    <div class="patrol-content">
        ...
        <div class="company-logo">
            <img src="{{ asset('images/blackbird1.png') }}" alt="Logo" class="logo-image">
        </div>
                ...
                <div class="col-md-6">
                    <div class="visit-action-card ingreso-card">
                        ...
                        <div class="action-card-body">
                            ...
                            <a href="{{route('vigilancia.regingreso',$designacion->id)}}" class="action-button ingreso-btn">
                                <i class="fas fa-sign-in-alt"></i>
                ...
                <div class="col-md-6">
                    <div class="visit-action-card salida-card">
                        ...
                        <div class="action-card-body">
                            ...
                            <a href="{{route('vigilancia.regsalida',$designacion->id)}}" class="action-button salida-btn">
                                <i class="fas fa-sign-out-alt"></i>
