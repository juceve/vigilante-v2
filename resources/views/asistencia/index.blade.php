                                ...
                                <tbody>
                                    @foreach ($asistencias as $asistencia)
                                        <tr>
											...
											<td>{{ $asistencia->designacione_id }}</td>
											<td>{{ $asistencia->fecha }}</td>
											<td>{{ $asistencia->ingreso }}</td>
											<td>{{ $asistencia->salida }}</td>
											<td>{{ $asistencia->latingreso }}</td>
											<td>{{ $asistencia->lngingreso }}</td>
											<td>{{ $asistencia->latsalida }}</td>
											<td>{{ $asistencia->lngsalida }}</td>
