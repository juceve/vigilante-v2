...
@section('content')
    <div class="container py-5" id="resumen-registro" style="font-family: 'Nunito', sans-serif;">
        <div class="card shadow-lg border-0 rounded-4">
            ...
            <div class="card-header bg-gradient-to-end d-flex justify-content-between align-items-center rounded-top-4"
                ...
                <h3 class="mb-0 fw-bold" style="letter-spacing: 0.5px;">Resumen de Registro</h3>
